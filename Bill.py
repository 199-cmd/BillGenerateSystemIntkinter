...
class Bill_App:
	def __init__(self,root):
		...
		self.root.title("Bill Generated System in python")
		bg_color='#074463'
		title=Label(self.root,text="Bill Generated System in python",bd=12,relief=GROOVE,bg=bg_color,fg="white",font=("times new roman",30,"bold"),pady=2).pack(fill=X)
		#================Variables==========================
		#================Cosemetics==========================
		...
		F1=LabelFrame(self.root,bd=8,relief=GROOVE,text="Customer Details",font=("times new roman",15,"bold"),fg="gold",bg=bg_color)
		...
		F2=LabelFrame(self.root,bd=8,relief=GROOVE,text="Cosemetics",font=("times new roman",15,"bold"),fg="gold",bg=bg_color)
		...
		F3=LabelFrame(self.root,bd=8,relief=GROOVE,text="Groceries",font=("times new roman",15,"bold"),fg="gold",bg=bg_color)
		...
		F4=LabelFrame(self.root,bd=8,relief=GROOVE,text="Cold Drinks",font=("times new roman",15,"bold"),fg="gold",bg=bg_color)
		...
		F6=LabelFrame(self.root,bd=8,relief=GROOVE,text="BILL MENU",font=("times new roman",15,"bold"),fg="gold",bg=bg_color)
...
#=============functions for working=============================
	...
	def Exit_app(self):
		op=messagebox.askyesno("Exit","Are you Sure Want to Exit")
		if op>0:
			self.root.destroy()
